...
function calculate(){
 ...
 $('batchLabel').hidden=!production;$('purchaseBasisLabel').hidden=production;$('rateLabel').hidden=production||batchPurchase;$('purchaseBatchQtyLabel').hidden=!batchPurchase;$('purchaseBatchCostLabel').hidden=!batchPurchase;$('purchaseBatchUnitLabel').hidden=!batchPurchase;
